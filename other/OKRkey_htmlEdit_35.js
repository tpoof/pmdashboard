<div id="pkWrap35" style="max-width: 820px;">
  <div style="display:flex; gap:0.75rem; align-items:flex-end; flex-wrap:wrap;">
    <div style="flex:1; min-width: 260px;">
      ...
      <input id="pkSearch35" type="text" autocomplete="off" placeholder="Search OKR key or name"
...
(function () {
  ...
  const selectedEl = document.getElementById("pkSelected35");
  ...
  function renderSelected() {
    ...
    selectedEl.innerHTML = `
      <div style="display:flex; justify-content:space-between; gap:0.75rem; align-items:flex-start;">
        ...
        <button type="button" class="buttonNorm" id="pkClearSelected35" style="white-space:nowrap;">Remove</button>
      </div>
    `;

    const btn = document.getElementById("pkClearSelected35");
