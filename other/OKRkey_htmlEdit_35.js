<div id="pkWrap35" style="max-width: 820px;">
  <div id="pkSummary35" style="display:flex; gap:0.75rem; align-items:center; flex-wrap:wrap;">
    <div style="font-weight:600; min-width:120px;">OKR</div>
    <div id="pkSummaryVal35" style="flex:1; min-width:200px; padding:0.25rem 0;">None selected</div>
    <button type="button" id="pkToggle35" class="buttonNorm" aria-expanded="false" aria-controls="pkPanel35" style="white-space:nowrap;">Change</button>
  </div>

  <div id="pkPanel35" style="display:none; margin-top:0.6rem;">
    <div style="display:flex; gap:0.75rem; align-items:flex-end; flex-wrap:wrap;">
      <div style="flex:1; min-width: 260px;">
        <input id="pkSearch35" type="text" autocomplete="off" placeholder="Search OKR key or name" aria-label="Search OKR key or name"
