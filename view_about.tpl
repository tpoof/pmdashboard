...
<br /><br />
<strong>LEAF Project Dashboard Documentation</strong>
<ul>
    <li><a href="https://github.com/stephluma/LEAF/blob/main/projects/executive_summary.md" target="_blank" rel="noopener">Executive Summary</a> (Markdown)</li>
    <li><a href="https://github.com/stephluma/LEAF/blob/main/projects/technical_design.md" target="_blank" rel="noopener">Technical Documentation / Design</a> (Markdown)</li>
</ul>
</div>
<br /><br />
